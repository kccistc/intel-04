...
def main():
    ...
    while True:
        ...
        if active_object_id >= 0:
            ...
            if recognizer_result is not None:
                ...
                if action_class_score > args.action_threshold:
                    ...
                    if last_text != action_class_label:
                        print(action_class_label)
                        
                        with open(file_path, 'a') as f:
                            f.write(action_class_label + " ")
                        f.close()
                        
                        last_text = action_class_label
        ...
        if key == 27:  # esc
            ...
            subprocess.run(["python3", "text_to_speech_demo.py",
                            "-i", "./talk.txt",
                            "-o", "./audio.wav",
                            "-m_duration", "intel/text-to-speech-en-multi-0001/text-to-speech-en-multi-0001-duration-prediction/FP16/text-to-speech-en-multi-0001-duration-prediction.xml",
                            "-m_forward", "intel/text-to-speech-en-multi-0001/text-to-speech-en-multi-0001-regression/FP16/text-to-speech-en-multi-0001-regression.xml",
                            "-m_melgan", "intel/text-to-speech-en-multi-0001/text-to-speech-en-multi-0001-generation/FP16/text-to-speech-en-multi-0001-generation.xml"])
