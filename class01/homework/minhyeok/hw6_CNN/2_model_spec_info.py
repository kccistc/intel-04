...
historyNoBatch = pickle.load(open('./hw6_CNN/historyNoBatch', "rb"))
historyBatch = pickle.load(open('./hw6_CNN/historyBatch', "rb"))
historylelu = pickle.load(open('./hw6_CNN/historyBatchReLu', "rb"))
