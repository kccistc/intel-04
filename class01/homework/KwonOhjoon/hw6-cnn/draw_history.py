...
# 모델 학습 history 불러오기
historyNoBatch = pickle.load(open('./historyWithoutBatch', "rb"))
historyBatch = pickle.load(open('./historyWithBatch', "rb"))
historylelu = pickle.load(open('./historyWithReLU', "rb"))
