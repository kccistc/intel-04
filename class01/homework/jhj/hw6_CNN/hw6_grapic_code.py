...
historyNoBatch = pickle.load(open('./fashion_mnist(without batch).h5', "rb"))
historyBatch = pickle.load(open('/fashion_mnist_relu.h5', "rb"))
historylelu = pickle.load(open('./fashion_mnist(with_batch).h5', "rb"))
